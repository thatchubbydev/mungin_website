  ...
  return (
    ...
    <div className='w-[500px] h-[450px] mb-32 bg-white rounded-xl p-6'>
        ...
        <button onClick={()=> closeSubModal(false)}>
            {/* back button was implemented by setting closeModalSub prop to false
                closeModal which is responsible for creating the ModalMain component is being passed into closeModalSub through props
                which makes closeModal === closeModalSub  */}
            <div className='flex'>
                    <div className='mr-1'>
