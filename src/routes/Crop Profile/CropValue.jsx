...
import crop_v from '../../assets/green_vector/crop_v.png'
        ...
        <div className=' pt-6 w-1/4 shadow-3xl'>
            ...
            <Link to={'/crop_v'}>
                <div className='flex pl-6 py-4 space-x-4 mt-6 bg-[#F4F4F4]'>
                    ...
                    <p className='text-[#778761] font-bold'>Crop Value</p>
                </div>
            </Link>
        ...
        <div className='mt-10 flex w-full flex-col'>
            ...
            <div className='flex flex-col m-8 space-y-12 '>
                ...
                <div className='text-left w-3/5'>
                    ...
                    <p className='text-[#565656]'>Industries in need of cassava starch include textile, pharmaceuticals, food and beverages,
                     paper and packaging, manufacturing and chemicals.</p>
                </div>
            </div>
