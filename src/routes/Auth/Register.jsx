      ...
      <div className='md:w-1/2 sm:w-full container mx-auto mt-10 ml-20'>
        ...
        <div className='text-[#313131] space-y-6'>
          ...
          <div>
            ...
            <input type='text' placeholder='hotel jerry' className='py-3 pl-4 flex-1  border w-4/5'/>
          </div>
          {/* email */}
          <div>
            <p className='mb-2'>Email Address</p>
            <input type='email' placeholder='hoteljerry@gmail.com' className='py-3 pl-4 flex-1  border w-4/5'/>
          </div>
          {/* password */}
          <div>
            <p className='mb-2'>Password</p>
            <input type='password' placeholder='hotel jerry' className='py-3 pl-4 flex-1  border w-4/5'/>
          </div>
          {/* button container */}
          <div>
            <button className='py-3 pl-2 flex flex-1 justify-center border w-4/5 bg-[#17233C] text-white'>Register</button>
          </div>
