      ...
      <div className='md:w-1/2 sm:w-full container mx-auto mt-10 ml-20'>
        ...
        <div className='text-[#313131] space-y-6'>
          ...
          <div>
            ...
            <input type='password' placeholder='1234' className='py-3 pl-4 flex-1  border w-1/2'/>
          </div>
          {/* button container */}
          <div>
            <button className='py-3 pl-2 flex flex-1 justify-center border w-1/2 bg-[#17233C] text-white'>Login</button>
          </div>
